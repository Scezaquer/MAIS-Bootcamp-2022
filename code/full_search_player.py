...
depth = 5	#Must be at least 1 to return a list of move evaluations, otherwise for depth = 0 it just returns the naive evaluation of the current board
